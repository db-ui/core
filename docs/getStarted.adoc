...
For manage your CRA to work with SASS include Path you have to update or create your .env file:

----
SASS_PATH=node_modules
----

In addition to get the asset paths working you have to load them separately. Further description is written above under _Webpack based bundlers_.
